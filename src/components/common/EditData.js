const fetchDataById = async (id, apiEndpoint, setDataFunction, setEditModeFunction, setRegistrationDataNotice) => {
  ...
  const registerManager = async (registrationData, fetchData) => {
    try {
        ...
        formData.append('nameManager', registrationData.nameManager);
        formData.append('email', registrationData.email);
        formData.append('password', registrationData.password);
        formData.append('role', registrationData.role);
        formData.append('managerKey', registrationData.managerKey);
        formData.append('photo', registrationData.photo); // Здесь передается файл изображения
  ...
  const registerClient = async (registrationData, fetchdata, upload) => {
    try {
